...
const projects = [
  // 01
  {
    ...
    title: "project 1",
    description:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum eveniet iste sit illo.",
          ...
          <div className="w-full xl:w-[50%]">
            ...
            >
              ...
              <WorkSliderBtns
                ...
                btnStyles="bg-accent-default hover:bg-accent-hover text-primary-color text-[22px] w-[44px] h-[44px] flex justify-center items-center transition-all"
              />
            </Swiper>
          </div>
        </div>
